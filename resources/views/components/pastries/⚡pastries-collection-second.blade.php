    ...
    <section>
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
            ...
            <div class="scrollbar-hide -mx-4 flex flex-1 gap-4 overflow-x-auto scroll-smooth px-4 pb-2 sm:-mx-6 sm:px-6 lg:mx-0 lg:px-0">
                @foreach ($this->pastriesTwo as $pastry)
            ...
            <div class="w-full shrink-0 lg:w-[220px]">
                <h2 class="text-sm font-bold uppercase tracking-wide text-stone-900">FOR YOUR SWEET TOOTH</h2>

                <p class="mt-3 text-sm leading-relaxed text-stone-600">
                    For every sweet tooth and every little craving, there’s something delicious waiting for you. From rich, irresistible chocolates and beautifully frosted cupcakes to sugary doughnuts, crunchy chin chin, our sweet collection is all about turning everyday moments into something special.
                </p>

                <p class="mt-3 text-sm leading-relaxed text-stone-600">
                    Whether you’re treating yourself, sharing with loved ones, or simply craving a little sweetness, there’s always a delightful bite to enjoy.
                </p>
