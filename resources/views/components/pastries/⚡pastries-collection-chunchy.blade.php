...
{{-- Intro column --}}
            <div class="w-full shrink-0 lg:w-[220px]">
                <h2 class="text-sm font-bold uppercase tracking-wide text-stone-900">Chunchy Moments</h2>

                <p class="mt-3 text-sm leading-relaxed text-stone-600">
                   Crunchy, golden, and irresistibly delicious, our chin chin is the perfect bite for every craving. 

               </p>

                <p class="mt-3 text-sm leading-relaxed text-stone-600">
                  Carefully made for that satisfying crunch and lightly sweetened for just the right taste, it’s a timeless favourite that’s perfect for snacking, sharing, or enjoying whenever you need a little treat. One bite is never enough!
                </p>
            ...
            <div class="scrollbar-hide -mx-4 flex flex-1 gap-4 overflow-x-auto scroll-smooth px-4 pb-2 sm:-mx-6 sm:px-6 lg:mx-0 lg:px-0">
                @foreach ($this->chunchy as $pastry)
