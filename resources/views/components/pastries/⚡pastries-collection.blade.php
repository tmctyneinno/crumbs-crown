    ...
    <section>
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
            ...
            <div class="w-full shrink-0 lg:w-[220px]">
                <h2 class="text-sm font-bold uppercase tracking-wide text-stone-900">Our PASTARY Collection</h2>

                <p class="mt-3 text-sm leading-relaxed text-stone-600">
                    From flaky, golden layers and buttery croissants to crunchy bites, soft pastries, and indulgent sweet treats, there’s always something freshly baked and delicious waiting for you. 
                </p>

                <p class="mt-3 text-sm leading-relaxed text-stone-600">
                    Made with quality ingredients and baked with care, our pastries are perfect for a quick morning treat, a relaxing afternoon bite, or something special to share with the people you love.
                </p>
