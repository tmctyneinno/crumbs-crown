...
<div>
    <div class="bg-white">
        ...
        <div class="mx-auto max-w-5xl space-y-14 px-0 py-10 sm:px-6">
            <livewire:custom-cake.idea-to-cake />
            <livewire:custom-cake.cake-style />

            <livewire:cake.flavours :flavours="$this->flavours" />
            <livewire:cake.size-guide :size-guide="$this->sizeGuide" />
            <livewire:custom-cake.cake-created />
            <livewire:custom-cake.faq /> 
        </div> 
    </div>
